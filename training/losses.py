...
class MTHARSLossV2(nn.Module):
    """
    An alternative (experimental) combined loss with optional class weights
    and per-class focal terms (not used in the paper, but might be useful
